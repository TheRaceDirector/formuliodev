...
# Compile the regular expressions for matching round numbers and extracting parts of the filename
...
def format_title(filename, grand_prix_name):
    # Set a default value for title_part
    title_part = "Unknown"
...
def process_csv(file_path, output_file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        for row in reader:
            ...
            key = f'hpytt0202402:{round_number}:{formatted_episode_number}'
