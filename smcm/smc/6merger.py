...
config_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'moto_config.json')
...
grand_prix_regex = re.compile(r'2024x\d+\.(.+?)\.(Qualifying|Race|Sprint|Sky|1080p)', re.IGNORECASE)
...
def process_csv(file_path, output_file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        for row in reader:
            ...
            key = f'hpytt0202411:{round_number}:{formatted_episode_number}'
